...
class PositionController(object):
    ...
    #print(self.angle_pitch," ",self.angle_roll," ",self.angle_yaw)
        ...
        z_acceleration_command = 2*self.damping_x*self.natural_frequency_x*(velocity_z_desired - z_velocity) +np.power(self.natural_frequency_x,2) * (self.position_controller_z_translation_desired-self.position_controller_z_translation)
