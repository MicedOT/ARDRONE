...
class ROSControllerNode(object):
    ...
    def run_stuff(self):
        ...
        while(True):
            if (((self.translation_x_desired - 0.30) < self.translation_x < (self.translation_x_desired + 0.30)) and((self.translation_y_desired - 0.30) < self.translation_y < (self.translation_y_desired + 0.30)) and((self.translation_z_desired - 0.30) < self.translation_z < (self.translation_z_desired + 0.30))):
                #self.pub_check.publish("true")
